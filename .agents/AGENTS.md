...
## AI Agent Rules for `idel-wrestler`

1. **Context Preservation:** At the end of any task that modifies code structure, API contracts, socket events, or feature sets, you MUST update `CONTEXT.md` in the workspace root.
